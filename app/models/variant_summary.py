...
class VariantSummary(Base):
    ...
    is_driver: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default="false")
    reported_flag: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default="false")
    source_file_asset_id: Mapped[str | None] = mapped_column(ForeignKey("file_assets.file_asset_id"), nullable=True)
